      ...
      <div className="footer-content">
        <div className="logo-detail-container">
          ...
          <div className="detail-content">
            HTC ALWAYS STRIVES TO CREATE THE BEST NFT ART PRODUCTS, CONTRIBUTING TO THE DEVELOPMENT OF ECOSYSTEMS ON HTC, SUPPORTING NFT STARTUPS, AND NURTURING THE PASSION OF ARTISTS. WE ALWAYS LISTEN TO THE COMMUNITY'S FEEDBACK AND GROW TOGETHER.
          </div>
        </div>
